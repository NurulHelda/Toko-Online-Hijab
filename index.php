...
<body>
    ...
    <header>
        ...
        <div id="slider">
            <figure>
                <img src="img/image-slide2.jpg" style="width: 20%; height: 450px;">
                <img src="img/image-slide3.jpg" style="width: 20%; height: 450px;">
                <img src="img/image-slide4.jpg" style="width: 20%; height: 450px;">
                <img src="img/image-slide5.jpg" style="width: 20%; height: 450px;">
                <img src="img/image-slide6.jpg" style="width: 20%; height: 450px;">
            </figure>
        </div>
    ...
    <div class="container">
        <footer class="py-5">
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="footer.php" class="nav-link p-0 text-muted">BEAUTY HIJAB Point</a></li>
                ...
                <div class="col-2">
                    <h5>TENTANG KAMI</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="footer.php" class="nav-link p-0 text-muted">Tentang Beauty Hijab</a></li>
            ...
            <div class="d-flex justify-content-between py-4 my-4 border-top">
                <p>&copy; 2022 Beauty Hijab, All rights reserved.</p>
